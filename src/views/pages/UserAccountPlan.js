    ...
    <div class="container-fluid">
        ...
        <div class="col-sm-12 col-md-10">
            ...
            <form action="" method="GET">
                <div class="row-pad">
                    <a href="./plano-conta-cadastro.html" class="btn btn-warning btn-action actions-button">
                ...
                <table class="table table-stripped table-cadastro">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" type="button" data-toggle="tooltip" data-placement="top" title="Editar">
